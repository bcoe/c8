...
const SourceMapUtil = require('./source-map-util')
...
class Report {
  ...
  run () {
    const map = this.sourceMapUtil.remap(this.getCoverageMapFromAllCoverageFiles())
  ...
  getCoverageMapFromAllCoverageFiles () {
    ...
    for (const v8ScriptCov of v8ProcessCov.result) {
      try {
        ...
        // fetch and cache source-map if it exists.
        // TODO: consider using source-map directly, or an equivalent
        // to reduce our dependency graph.
        this.sourceMapUtil.extractAndCacheSourceMap(script.source, path)
